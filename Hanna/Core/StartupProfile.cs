...
internal sealed class StartupProfile
{
    ...
    public StartupDecision DecideTelegram()
    {
        ...
        return StartupDecision.Start("TELEGRAM_TOKEN válido.");
    }
    ...
    public StartupDecision DecideScreenAnalysis()
    {
        ...
        return StartupDecision.Start("Perfil permite análisis de pantalla y HANNA_SCREEN_ANALYSIS_ENABLED=true.");
    }
...
{
    public static StartupDecision Start(string detail) => new(true, "perfil/configuración", detail);
